...
- Project Rocket is a web application that allows users to search for a country, submit a review to share their travel experiences of that country, and read other users' experiences.
...
- We have 3 kinds of resources in our API: [Country](https://github.com/Project-Rocket-Web-App/blob/master/README.md#countries), [Currency](https://github.com/Project-Rocket-Web-App/blob/master/README.md#currencies), and [Message](https://github.com/Project-Rocket-Web-App/blob/master/README.md#messages), and therefore 3 collections: Countries, Currencies, and Messages  
